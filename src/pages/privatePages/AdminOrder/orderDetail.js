...
export default class AdminOrderDetail extends React.Component {
    static defaultProps = { activeClass: { 'order': 'active' } };
    render() {
        return (
                        ...
                        <div className="card card-block card-stretch card-height print rounded">
                            <div className="card-header d-flex justify-content-between bg-primary header-invoice">
                                ...
                                <div className="invoice-btn">
                                    <button type="button" className="btn btn-primary-dark mr-2"><i className="las la-print"></i>
                                        Print
                                        Print</button>
                                    <button type="button" className="btn btn-primary-dark"><i
                                        className="las la-file-download"></i>PDF</button>
                                </div>
                            </div>
                            <div className="card-body">
                                <div className="row">
                                    <div className="col-sm-12">
                                        <img src="../assets/images/logo.png" className="logo-invoice img-fluid mb-3" />
                                            ...
                                            <table className="table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>250028</td>
                                                        <td>
                                                            <p className="mb-0">PO Box 16122 Collins Street West<br />Victoria
                                                                8007 Australia<br />
